...
The Antora playbook in this repository fetches content from private GitHub repositories (`docs`, `cloud-docs`, and `rp-connect-docs`), so building the site requires a GitHub token — even for read-only builds.
