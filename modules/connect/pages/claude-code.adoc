...
TIP: The provider's *Connect* tab in ADP generates this Claude Code configuration (environment variables or a settings-file snippet) with your provider's proxy URL prefilled. Pick *Claude Code* under *Connect to your client*.
