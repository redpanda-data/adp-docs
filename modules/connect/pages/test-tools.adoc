...
The command resolves the gateway URL from your active rpk cloud profile and reads the cached `rpk cloud login` token. See xref:gateway:connect-agent.adoc[Connect your app to AI Gateway] for installation and profile setup.
