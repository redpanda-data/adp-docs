...
:learning-objective-2: Inspect resources and prompts, and review session activity
...
. Open *MCP Servers* in the navigation menu and click into your server.
...
*Protocol panel* opens a panel next to the runner with three tabs:
