...
image::mcp-inspector-lifecycle.svg[alt="MCP Inspector flow. The Inspector identifies the server's MCP version and capabilities, discovers tools, resources, and prompts, sends a selected tool call as JSON-RPC, and shows the formatted result beside the wire frames, timing, progress, and errors."]
...
// Verified against the current ADP implementation on 2026-08-07.
