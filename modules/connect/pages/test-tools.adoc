...
// Result-card tabs and binary-resource rendering verified 2026-08-07 against adp-ui inspector-tools-panel-cards.tsx (the Raw JSON-RPC envelope carries both the request and the response) and inspector-resources-panel.tsx (binary payloads render a size note, no download link) on origin/main.
