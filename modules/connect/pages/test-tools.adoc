...
The command targets the AI Gateway of your selected ADP environment, using credentials from `rpk ai auth login`. See xref:gateway:connect-agent.adoc[Connect your app to AI Gateway] for installation and sign-in.
