...
Register GitHub as an OAuth provider in the Agentic Data Plane UI.
...
|**Display name** *
|`GitHub`
|Human-readable name shown in the Agentic Data Plane UI.
...
. In the Agentic Data Plane UI, find your GitHub MCP server in the **MCP Servers** list.
...
* xref:connect:managed/managed-catalog.adoc[Managed MCP Catalog]
