...
The auth modes from xref:connect:create-server.adoc#configure-authentication[create-server.adoc] all apply. Several patterns are particularly common for self-managed servers:
