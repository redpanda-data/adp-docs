...
* If using user-delegated OAuth: an OAuth Provider already configured. See xref:connect:user-delegated-oauth.adoc[User-delegated OAuth].
...
For user-delegated OAuth, the URL must be `https://` and you also need an OAuth Provider. See xref:connect:user-delegated-oauth.adoc[User-delegated OAuth].
