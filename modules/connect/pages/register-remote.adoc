...
* If using user-delegated OAuth: nothing to prepare when you let Redpanda set up OAuth automatically. To attach an OAuth provider your organization already manages instead, register it first. See xref:connect:user-delegated-oauth.adoc[User-delegated OAuth].
