...
:page-aliases: mcp:register-remote.adoc
...
The five auth modes from xref:connect:create-server.adoc#configure-authentication[create-server.adoc] all apply. Three patterns are particularly common for self-managed servers:
