...
// Source: cloudv2 apps/adp-ui/src/components/connections/ (connection-master-rail.tsx buckets, connection-detail-pane.tsx badges/actions, connection-status.ts reconnectDeadline).
...
// Source: cloudv2 proto/public/cloud/redpanda/api/adp/v1alpha1/oauth_connection.proto ConnectionStatus ACTIVE/EXPIRED semantics + Connection.refresh_token_present / refresh_token_expires_at.
