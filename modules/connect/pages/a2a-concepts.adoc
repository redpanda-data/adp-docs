...
The Agent-to-Agent (A2A) protocol is an open standard for agent communication and discovery. Redpanda ADP uses A2A for both external integration and internal pipeline-to-agent communication.
...
* New agents become available immediately after deployment
