...
+
* `Spec`: A URL to the OpenAPI 3.x spec (JSON or YAML), or paste the spec inline. Set exactly one. Inline specs are capped at 1 MiB; host larger specs and use the URL instead.
