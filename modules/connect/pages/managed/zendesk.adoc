...
:page-aliases: mcp:managed/zendesk.adoc
...
* For *User OAuth* mode: a Zendesk OAuth client and an OAuth Provider configured in ADP. See xref:connect:oauth-providers.adoc[Configure an OAuth Provider].
...
Create a new Zendesk MCP server in the Agentic Data Plane UI:
