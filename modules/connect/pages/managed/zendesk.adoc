...
* For *User OAuth* mode: a Zendesk OAuth client and an OAuth Provider configured in Redpanda ADP. See xref:connect:oauth-providers.adoc[Configure an OAuth Provider].
