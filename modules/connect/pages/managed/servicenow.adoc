...
* For User-OAuth mode: an glossterm:OAuth provider[,OAuth Provider] configured in Redpanda Agentic Data Plane. See xref:connect:oauth-providers.adoc[Configure an OAuth Provider].
...
[source,bash]
----
rpk ai mcp-server create --name acme-servicenow --managed-config '{
...
[source,bash]
----
rpk ai mcp-server create --name acme-servicenow-oauth --managed-config '{
  "@type": "type.googleapis.com/redpanda.mcps.servicenow.v1.ServiceNowMCPConfig",
  "instance_url": "https://acme.service-now.com",
  "oauth": {
...
[source,bash]
----
rpk ai mcp-server create --name acme-servicenow-user --managed-config '{
  "@type": "type.googleapis.com/redpanda.mcps.servicenow.v1.ServiceNowMCPConfig",
  "instance_url": "https://acme.service-now.com",
  "user_oauth": {
