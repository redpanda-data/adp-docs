...
[NOTE]
====
The ServiceNow managed MCP server is in alpha. It has not yet been tested internally, so its behavior and configuration may change, and it is not recommended for production use.
====
