...
* Two Redpanda Agentic Data Plane secret-store entries:
+
...
Create a new Workday MCP server in Agentic Data Plane:
...
// TODO: capture screenshots of the Workday create form on the live environment.

=== Configure from the CLI

[source,bash]
----
rpk ai mcp-server create --name workday-hr --managed-config '{
