...
Once the Kafka server is created, point an agent at the `MCP Server URL` on the server's detail page. The agent can then produce messages to topics through the exposed `produce` tool.
