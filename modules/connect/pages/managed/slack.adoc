...
* An glossterm:OAuth provider[,OAuth Provider] configured in ADP under *OAuth Providers*, pointing at Slack's authorize/token URLs and carrying the OAuth app's client credentials. See xref:connect:oauth-providers.adoc[Configure an OAuth Provider].
