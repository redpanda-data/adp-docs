...
:page-aliases: mcp:managed/ironclad.adoc
...
* An OAuth Provider configured in ADP for Ironclad. See xref:connect:oauth-providers.adoc[Configure an OAuth Provider].
