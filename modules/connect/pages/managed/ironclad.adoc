...
* An OAuth Provider configured in ADP for Ironclad. See xref:mcp:oauth-providers.adoc[Configure an OAuth Provider].
...
Create a new Ironclad MCP server in the Agentic Data Plane UI:
