...
// Decision (Michele, 2026-08-07): the "Configure A2A discovery metadata" section was cut.
// The UI exposes no form to edit A2A identity or skill metadata; the agent card is served
// at /.well-known/agent-card.json. Do not re-add unless the product ships an editing surface.
