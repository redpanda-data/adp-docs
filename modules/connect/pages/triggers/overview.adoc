= Trigger Agents
:page-aliases: connect:triggers/index.adoc
...
// Source: cloudv2 `proto/public/cloud/redpanda/api/adp/v1alpha1/agent.proto` (Trigger, TeamsTrigger, CronTrigger) cross-referenced against `apps/adp-ui/src/components/agents/triggers/` on origin/main. UI surface verified against the live environment: Microsoft Teams on 2026-06-11, Schedule on 2026-07-24. Microsoft Teams and Schedule are selectable in the production trigger picker; the Slack and Webhook tiles are disabled and not documented.
