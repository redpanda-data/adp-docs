...
* For a common cadence, pick a preset from *Runs* and set the time. The presets are *Hourly*, *Daily*, *Weekdays*, *Weekly*, and *Monthly*.
* For a schedule the presets don't cover, expand *Advanced — cron expression* and enter a standard five-field cron expression.
