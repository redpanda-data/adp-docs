...
// Source: cloudv2 `proto/public/cloud/redpanda/api/adp/v1alpha1/agent.proto` (Trigger, CronTrigger, TriggerRun) cross-referenced against `apps/adp-ui/src/components/agents/triggers/` and the scheduler in `apps/adp-api/internal/agent/trigger/cron/` on origin/main. UI surface verified against the live environment on 2026-07-24.
