...
. Open *Integrations setup* in the sidebar and select the *Inbound clients* tab. It lists every external tool registered to request access tokens from this gateway, with its `Name`, `Grant Types`, `Status`, and `Scopes`.
...
* A footer reminding the user that they can revoke access from their *My Connections* page in Agentic Data Plane.
+
