...
TIP: You can also review and change DCR self-registration from the UI: on the *Integrations setup* page, open the *Inbound clients* tab and click *Manage DCR* to open the DCR governance panel.
