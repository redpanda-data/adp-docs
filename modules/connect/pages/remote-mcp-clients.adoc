...
:page-aliases: integrations:remote-mcp-clients.adoc
...
* *Microsoft Copilot Studio*: Recent builds support remote MCP custom connectors registered against an external OAuth 2.0 authorization server. Register Copilot Studio's published redirect URIs on the AI Gateway OAuth Client before connecting.
