...
* AI Gateway deployed on a BYOC environment running Redpanda version 25.3 or later
...
Create a separate gateway for each tenant or team. Each gateway has its own rate limits, spending limits, and API tokens.
...
. Use overall rate limits and spending limits to control aggregate usage.
