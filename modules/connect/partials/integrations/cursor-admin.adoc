...
. Navigate to *AI Gateway* > *Providers* in Agentic Data Plane
...
. Navigate to *Security* > *API Tokens* in Agentic Data Plane
. Click *Create Token*
. Enter token details:
+
[cols="1,2"]
...
. In Agentic Data Plane, create one gateway per team (for example, `team-alpha-cursor-gateway`, `team-beta-cursor-gateway`).
