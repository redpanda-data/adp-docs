...
. **MCP overhead**
+
If not using deferred tool loading, all tools load with every request. Enable deferred tool loading in your AI Gateway configuration (see xref:gateway:aggregation.adoc[]).
