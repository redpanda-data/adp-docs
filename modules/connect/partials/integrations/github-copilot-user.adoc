...
:learning-objective-2: Set up multi-tenancy with per-team gateways for cost tracking
:learning-objective-3: Configure enterprise BYOK deployments for team-wide Copilot access

After xref:get-started:gateway-quickstart.adoc[configuring your AI Gateway], set up GitHub Copilot to route LLM requests through the gateway for centralized observability, cost management, and provider flexibility.

After reading this page, you will be able to:

* [ ] Configure GitHub Copilot in VS Code and JetBrains IDEs to route requests through AI Gateway.
* [ ] Set up multi-tenancy with per-team gateways for cost tracking.
...
Use separate gateways per team to track and enforce budgets. Configure alerts in the dashboard when teams approach their limits.
...
* xref:ai-gateway/integrations/cursor-user.adoc[]: Configure Cursor IDE with AI Gateway
