...
+
* Enable deferred tool loading in your AI Gateway configuration (see xref:ai-gateway:aggregation.adoc[])
...
See xref:ai-gateway:aggregation.adoc[] for MCP tool configuration.
