...
+
* Enable deferred tool loading in your AI Gateway configuration (see xref:gateway:aggregation.adoc[])
...
See xref:gateway:aggregation.adoc[] for MCP tool configuration.
