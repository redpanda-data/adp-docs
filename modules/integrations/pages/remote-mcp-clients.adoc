...
+
// TODO(review-before-publish): forward-looking framing — "Auth0 today, Zitadel in a future release" exposes an internal IdP migration plan. Confirm whether to name the IdP at all in customer prose, or drop both names and just say "your AI Gateway identity provider".
