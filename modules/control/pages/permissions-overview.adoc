...
Access policies use their own action vocabulary. A policy names an entity type and a verb, such as `Action::"Agent.get"`, not the permission strings listed on this page. See xref:control:access-policies.adoc#action-reference[Action reference].
