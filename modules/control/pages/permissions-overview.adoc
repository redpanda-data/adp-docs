...
// Admin-only scoping of Agentic Data Plane permissions verified against `pkg/permissions/adp_role_permissions_test.go`, `pkg/permissions/permissions_constants.go` (writerRolePermissions, readRolePermissions), and `apps/backoffice-worker/internal/workflows/organization/builtin_roles.go` on origin/main, 2026-07-31.
