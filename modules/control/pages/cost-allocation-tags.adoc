...
Open *Cost & Usage* under *Governance* in the sidebar. For the page overview, see xref:control:cost-usage.adoc[Analyze Cost and Usage]. Tags add two independent controls:
...
* xref:control:cost-usage.adoc[Analyze Cost and Usage]
