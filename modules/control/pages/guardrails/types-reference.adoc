...
A guardrail bundles a set of policies, each backed by AWS Bedrock Guardrails. Every policy is optional. This page documents each policy's configuration, the actions it can take, and which direction (input, output, or both) it evaluates.
