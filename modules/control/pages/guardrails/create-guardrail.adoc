= Create a Guardrail
:description: Create a guardrail with the wizard, configure its Bedrock backend and policies, attach it to an LLM provider, and verify that it blocks.
...
Create a guardrail to inspect and control the requests and responses that flow through an LLM provider. You configure the guardrail in a wizard (details, backend, and policies), attach it to a provider, and confirm it blocks.
