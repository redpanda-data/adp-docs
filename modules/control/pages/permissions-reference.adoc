...
The `dataplane_adp_effectivepolicyset_*` permissions gate read access to the compiled policy set the dataplane enforces (your access policies plus the system policies generated from role bindings).
...
|View the compiled policy set
|✓
|✓

|`dataplane_adp_effectivepolicyset_list`
|List compiled policy sets
|✓
|✓
|===
