...
|*Reader*
|Auditors and evaluators who need visibility without mutation rights. Grants `_get` and `_list` plus MCP runtime read methods. Does not grant transcript reads.
