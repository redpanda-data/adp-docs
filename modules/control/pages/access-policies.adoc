...
// Action ids, entity types, attribute-bearing types, and validation rules verified against the generated Cedar schema and the Agentic Data Plane UI on 2026-07-30. Action ids are entity-qualified (`Agent.get`) and are not interchangeable with role permission strings.
