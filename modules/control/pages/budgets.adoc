...
|*Breakdown queries*
|Aggregated spend by *provider*, *model*, *user*, *agent*, or *provider type*. Available through the dashboard's provider-breakdown widget and through `GetSpendingBreakdown` for programmatic access.
|===
