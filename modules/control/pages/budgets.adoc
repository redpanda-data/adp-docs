...
For the per-evaluator cost model and how it interacts with the dashboard's spend view, see xref:control:guardrails/index.adoc[Configure guardrails].
...
* xref:control:guardrails/index.adoc[Configure guardrails]
