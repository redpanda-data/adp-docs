...
Note: gateway/aggregation.adoc was reframed and renamed to gateway/code-mode.adoc
("Code Mode"), a CURRENT page (old URL redirects via :page-aliases:). It is not part of this archive.
////
...
Redpanda AI Gateway, part of the Agentic Data Plane, is the managed proxy for LLM APIs. This quickstart walks you through configuring your first gateway and routing requests through it.
...
// Original Next steps: Agentic Data Plane Quickstart, gateway:aggregation, gateway:gateway-architecture, gateway:overview
...
* Access to Redpanda Agentic Data Plane with administrator privileges
...
. In Agentic Data Plane, navigate to *Agentic* > *AI Gateway* > *Providers*.
...
// Original xref: gateway:aggregation.adoc, reframed/renamed to gateway:code-mode.adoc (Code Mode); current page, kept.
...
. Share API credentials (Agentic Data Plane tokens with appropriate permissions)
...
* You have a Redpanda Agentic Data Plane account with access to at least one AI Gateway
* You have access to Agentic Data Plane or API credentials
...
Using the UI::
+
. In Agentic Data Plane, navigate to *AI Gateway* > *Gateways*.
