...
Enabled models sort to the top, followed by the newest catalog models. Use the search box to find a model by display name or identifier, and the *Status* and *Capability* filters to narrow the list. By default the tab hides legacy, deprecated, and unavailable models; turn on *Show legacy, deprecated, and unavailable models* to include them.
...
|`24h requests`
|Request count over the last 24 hours, with a sparkline.

|`30d spend`
|Spend over the last 30 days, with a sparkline. For longer-range or cross-provider analysis, use the *Cost & Usage* page under *Governance* (see <<view-cost-and-usage>>).
|===
