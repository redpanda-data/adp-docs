...
|`Credential type`
|How AI Gateway authenticates to Bedrock: *Default chain*, *Static keys*, or *Assume IAM role*. Defaults to *Default chain*. The fields below depend on the mode you pick.
