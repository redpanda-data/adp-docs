...
See xref:gateway:aggregation.adoc[] for detailed information about MCP aggregation.
...
Users can then discover and connect to the gateway using the information provided. See xref:builders/discover-gateways.adoc[] for user documentation.

== Next steps

* xref:connect:claude-code.adoc[Connect Claude Code]
