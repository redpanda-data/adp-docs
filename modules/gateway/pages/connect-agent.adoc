...
* For CI or programmatic clients: A Redpanda service account with OIDC client credentials. Service accounts are managed in *Organization IAM*. See xref:cloud-data-platform:security:cloud-authentication.adoc[Authenticate to Redpanda Cloud].
...
// Updated for cloudv2 PR #27510: rpk ai is self-contained (its own auth login + Agentic Data Plane environment selection), no longer tied to the rpk cloud session.
