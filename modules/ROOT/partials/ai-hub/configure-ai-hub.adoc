...
If you need to modify backend pools or routing rules, eject the gateway to Custom mode. See xref:ai-gateway/admin/eject-to-custom-mode.adoc[] for details.
...
For ejection instructions, see xref:ai-gateway/admin/eject-to-custom-mode.adoc[].
