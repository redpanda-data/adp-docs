...
For implementation details, see xref:mcp:remote/tool-patterns.adoc[].
...
For implementation details, see xref:agents:pipeline-integration-patterns.adoc[].
...
To learn how the A2A protocol enables this integration, see xref:agents:a2a-concepts.adoc[].
