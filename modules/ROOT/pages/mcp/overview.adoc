...
:page-aliases: redpanda-cloud:ai-agents:mcp/overview.adoc
...
* xref:mcp:local/quickstart.adoc[]: Connect Claude to your Redpanda Cloud account
* xref:mcp:remote/quickstart.adoc[]: Build and deploy custom MCP tools
