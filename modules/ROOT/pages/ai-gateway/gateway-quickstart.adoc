...
For more CEL examples, see xref:ai-gateway/cel-routing-cookbook.adoc[].
...
For detailed Claude Code setup, see xref:ai-gateway/integrations/claude-code-user.adoc[].
endif::[]
...
ifdef::integrations-available[]
For detailed Continue setup, see xref:ai-gateway/integrations/continue-user.adoc[].
endif::[]
...
ifdef::integrations-available[]
For detailed Cursor setup, see xref:ai-gateway/integrations/cursor-user.adoc[].
endif::[]
...
* xref:ai-gateway/cel-routing-cookbook.adoc[]: Advanced CEL routing patterns for traffic distribution and cost optimization
* xref:ai-gateway/mcp-aggregation-guide.adoc[]: Configure MCP server aggregation and deferred tool loading
ifdef::integrations-available[]
* xref:ai-gateway/integrations/index.adoc[]: Connect more AI development tools
endif::[]

Learn about the architecture:

* xref:ai-gateway/gateway-architecture.adoc[]: Technical architecture, request lifecycle, and deployment models
* xref:ai-gateway/what-is-ai-gateway.adoc[]: Problems AI Gateway solves and common use cases
