...
ADP on BYOC uses Redpanda Cloud BYOC infrastructure on AWS. Use this reference to confirm the requirements before you create ADP resources on a BYOC environment.
