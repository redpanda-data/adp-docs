...
. Skip the *Filter* section. PetStore exposes a small catalog and the quickstart agent can see everything.

. If the form prompts for an *Authentication* mode further down, select *None*. PetStore is a public API.
