...
// The Governance dashboard section below is conditionalized out until the governance UI ships in adp-production.
// To surface it, define `env-adp-governance` in `antora.yml` (under `asciidoc.attributes`) or as a page attribute.
