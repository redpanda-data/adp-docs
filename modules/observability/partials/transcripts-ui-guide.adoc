...
//
// DEPENDENCIES:
//   - xref:observability:concepts.adoc#agent-trace-hierarchy[]
//   - xref:observability:concepts.adoc#mcp-server-trace-hierarchy[]
//
// CONTENT TYPE:
...
ifeval::["{context}" == "agent"]
For details on span types, see xref:observability:concepts.adoc#agent-trace-hierarchy[Agent trace hierarchy].
endif::[]
ifeval::["{context}" == "mcp"]
For details on span types, see xref:observability:concepts.adoc#mcp-server-trace-hierarchy[MCP server trace hierarchy].
endif::[]
