...
* *Tools*: External capabilities exposed through the xref:mcp:overview.adoc[Model Context Protocol (MCP)]
...
For a deeper understanding of how agents execute, manage context, and maintain state, see xref:concepts.adoc[].
...
* Agents are available only on xref:redpanda-cloud:get-started:cluster-types/byoc/index.adoc[BYOC clusters]
