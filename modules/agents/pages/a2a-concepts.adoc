...
The `a2a_message` processor uses the A2A protocol internally to discover and call agents. For pipeline patterns, see xref:pipeline-integration-patterns.adoc[].
