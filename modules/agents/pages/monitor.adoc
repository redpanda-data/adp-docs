...
You must have a running agent. If you do not have one, see xref:quickstart.adoc[].
...
For cost optimization strategies, see xref:concepts.adoc#cost-calculation[Cost calculation].
