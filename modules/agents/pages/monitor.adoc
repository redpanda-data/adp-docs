...
For conceptual background on traces and observability, see xref:observability:concepts.adoc[].

== Prerequisites

You must have a running agent. If you do not have one, see xref:agents:quickstart.adoc[].
...
:context: agent
include::observability:partial$transcripts-ui-guide.adoc[]
...
For cost optimization strategies, see xref:agents:concepts.adoc#cost-calculation[Cost calculation].
