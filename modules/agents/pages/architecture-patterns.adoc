...
For foundational concepts on how agents execute and manage complexity, see xref:concepts.adoc[].
...
For implementation details on external A2A integration, see xref:integration-overview.adoc[].
