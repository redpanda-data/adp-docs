...
For implementation details, see xref:pipeline-integration-patterns.adoc[].
...
To learn how the A2A protocol enables this integration, see xref:a2a-concepts.adoc[].
