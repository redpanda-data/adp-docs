...
* Test agents with the xref:system-prompts.adoc#evaluation-and-testing[systematic testing approach]
...
For comprehensive guidance on monitoring agent activity, analyzing conversation history, tracking token usage, and debugging issues, see xref:monitor.adoc[].
