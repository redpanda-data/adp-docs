...
:page-aliases: agents:monitor.adoc
...
You must have a running agent. If you do not have one, see xref:get-started:quickstart.adoc[].
...
. In ADP, navigate to *Agentic AI* > *AI Agents*.
