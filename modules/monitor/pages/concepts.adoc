...
The Audit Log view returns events for your Agentic Data Plane environment. Access requires an audit log permission. See xref:control:permissions-reference.adoc#audit-log-permissions[Audit log permissions].
