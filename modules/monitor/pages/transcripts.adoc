...
* Access to read transcripts, from an xref:control:access-policies.adoc[access policy] granting the `Transcript` actions, or from the Admin role. No other built-in role grants transcript reads.
