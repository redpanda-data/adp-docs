...
The transcript shows token usage per turn. For spend analysis across agents, models, and users, use the xref:control:dashboard/overview.adoc[Governance dashboard]; per-transcript `estimated_cost_usd` is also available through the Transcripts API.
