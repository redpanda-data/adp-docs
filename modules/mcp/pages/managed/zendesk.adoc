...
* xref:../oauth-providers.adoc[Configure an OAuth Provider]: Register the Zendesk OAuth client for User-OAuth mode.
* xref:../user-delegated-oauth.adoc[User-delegated OAuth]: The consent flow users walk through on first call.
