...
* An OAuth Provider configured in ADP for Ramp. See xref:mcp:oauth-providers.adoc[Configure an OAuth Provider].
* Familiarity with xref:mcp:user-delegated-oauth.adoc[User-delegated OAuth].
...
Create a new Ramp MCP server in the Agentic Data Plane UI:
