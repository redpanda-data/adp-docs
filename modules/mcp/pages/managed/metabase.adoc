...
Create a new Metabase MCP server in the ADP UI:
...
[source,bash]
----
rpk ai mcp create metabase --managed-config '{
...
* xref:mcp:managed/managed-catalog.adoc[Managed MCP Server Catalog]
* xref:mcp:managed/sql.adoc[SQL managed MCP]
