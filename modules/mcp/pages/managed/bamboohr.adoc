...
* xref:mcp:user-delegated-oauth.adoc[Configure user-delegated OAuth]
* xref:mcp:test-tools.adoc[Test a server's tools]
* xref:agents:create-agent.adoc[Create a declarative agent] that uses the BambooHR server
