...
TIP: For background on how MCP tools work and when to use each component type, see xref:remote/concepts.adoc[].
...
For detailed solutions, see xref:remote/troubleshooting.adoc[].
