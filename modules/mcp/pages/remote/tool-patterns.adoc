...
When building tools, use these patterns as starting points for common scenarios. For step-by-step instructions, see xref:mcp/remote/create-tool.adoc[]. For design guidelines, see xref:mcp/remote/best-practices.adoc[].
...
* xref:mcp/remote/troubleshooting.adoc[]