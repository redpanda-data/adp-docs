...
* xref:managed/slack.adoc[Slack managed MCP]
* xref:managed/jira.adoc[Jira managed MCP]
* xref:managed/zendesk.adoc[Zendesk managed MCP]
* xref:managed/workday.adoc[Workday managed MCP]
* xref:managed/ironclad.adoc[Ironclad managed MCP]
* xref:managed/ramp.adoc[Ramp managed MCP]
