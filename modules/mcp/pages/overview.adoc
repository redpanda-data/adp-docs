...
. *Browse the managed catalog* for the full list of types, their categories, and per-type configuration links. See xref:managed/managed-catalog.adoc[Managed catalog].
