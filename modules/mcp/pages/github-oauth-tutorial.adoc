...
|Click **New**, enter `GITHUB_CLIENT_SECRET` as the key name, and then click *Create secret*. This creates the secret in the Secrets Store and links it to this provider in ADP. If you already have a secret in Secrets Store, click **Existing** instead.
|===
