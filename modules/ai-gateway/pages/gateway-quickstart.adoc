...
For more CEL examples, see xref:routing-cel.adoc[].
...
* xref:routing-cel.adoc[]: Advanced CEL routing patterns for traffic distribution and cost optimization
* xref:aggregation.adoc[]: Configure MCP server aggregation and deferred tool loading
ifdef::integrations-available[]
...
* xref:overview.adoc[]: Problems AI Gateway solves and common use cases
