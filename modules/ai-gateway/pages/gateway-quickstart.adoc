...
See xref:gateway-modes.adoc[] to understand which mode fits your needs. This quickstart focuses on Custom mode configuration.
====
endif::[]
...
* *AI Hub*: Choose this for pre-configured intelligent routing (see xref:admin/configure-ai-hub.adoc[] for setup)
...
For more CEL examples, see xref:cel-routing-cookbook.adoc[].
...
* xref:cel-routing-cookbook.adoc[]: Advanced CEL routing patterns for traffic distribution and cost optimization
* xref:mcp-aggregation-guide.adoc[]: Configure MCP server aggregation and deferred tool loading
ifdef::integrations-available[]
* xref:integrations/index.adoc[]: Connect more AI development tools
endif::[]

Learn about the architecture:

* xref:gateway-architecture.adoc[]: Technical architecture, request lifecycle, and deployment models
* xref:what-is-ai-gateway.adoc[]: Problems AI Gateway solves and common use cases
