...
+
If not, see xref:builders/discover-gateways.adoc[].

* You have a service account with OIDC client credentials. See xref:redpanda-cloud:security:cloud-authentication.adoc[].
...
For details, see xref:redpanda-cloud:security:cloud-authentication.adoc#authenticate-to-the-cloud-api[Authenticate to the Cloud API].
...
// To see which models are available in your gateway, see xref:builders/available-models.adoc[].
...
// See xref:builders/monitor-your-usage.adoc[] for details.
...
See xref:integrations/claude-code-user.adoc[] for complete setup.
endif::[]
...
+
ifdef::integrations-available[]
See xref:integrations/continue-user.adoc[] for complete setup.
endif::[]
...
+
ifdef::integrations-available[]
See xref:integrations/cursor-user.adoc[] for complete setup.
endif::[]
====
...
// See xref:builders/monitor-your-usage.adoc[] for detailed monitoring.
...
// * Check available models: See xref:builders/available-models.adoc[]
...
// * xref:builders/use-mcp-tools.adoc[Use MCP Tools] - Access tools from MCP servers (if enabled)
// * xref:builders/monitor-your-usage.adoc[Monitor Your Usage] - Track requests and costs
ifdef::integrations-available[]
* xref:integrations/index.adoc[Integrations] - Configure specific tools and IDEs
endif::[]
