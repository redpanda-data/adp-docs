...
[TIP]
====
You can start with AI Hub mode and later eject to Custom mode if you need more control. Ejection is a one-way transition. See xref:admin/eject-to-custom-mode.adoc[].
====
...
* *AI Hub Mode*: See xref:admin/configure-ai-hub.adoc[] for setup instructions
