...
+
For advanced routing based on request properties, use CEL expressions. See xref:cel-routing-cookbook.adoc[] for examples.
+
...
See xref:mcp-aggregation-guide.adoc[] for detailed information about MCP aggregation.
...
* xref:cel-routing-cookbook.adoc[CEL Routing Cookbook] - Advanced routing patterns
