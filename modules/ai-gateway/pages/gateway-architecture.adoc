...
This page provides technical details about AI Gateway's architecture, request processing, and capabilities. For an overview of AI Gateway, see xref:overview.adoc[]
...
* xref:aggregation.adoc[]: Configure MCP server aggregation for AI agents
