...
* You have an ADP account with access to at least one AI Gateway
...
include::ROOT:partial$ai-hub-mode-indicator.adoc[]
...
* Limited customization through administrator-configured preference toggles
* See xref:builders/use-ai-hub-gateway.adoc[] for AI Hub-specific guidance
