...
* [ ] You've reviewed xref:ai-gateway/gateway-modes.adoc[] to understand alternatives
...
For CEL routing patterns, see xref:ai-gateway/cel-routing-cookbook.adoc[].
...
* xref:ai-gateway/cel-routing-cookbook.adoc[Learn CEL routing patterns] - Write powerful routing expressions
